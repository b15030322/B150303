...
int  createFile(Book boo[ ])              /*建立初始的数据文件*/
{
	FILE *fp;
	int n;
   	if((fp=fopen("C:\\Users\\wc\\Desktop\\新建文件夹\\图书管理系统.txt", "wb")) == NULL) /*指定好文件名，以写入方式打开*/
	{
...
int readFile(Book boo[ ] )                     /*将文件中的内容读出置于结构体数组stu中*/
{
   	FILE *fp;
	int i=0;
	if((fp=fopen("C:\\Users\\wc\\Desktop\\新建文件夹\\图书管理系统.tx", "rb")) == NULL)  /*以读的方式打开指定文件*/
	{
...
{   			
  	FILE *fp;	
   	if((fp=fopen("C:\\Users\\wc\\Desktop\\新建文件夹\\图书管理系统.tx", "wb")) == NULL) /*以写的方式打开指定文件*/
	{
		printf("can not open file !\n");           /*如果打开失败，输出提示信息*/
		exit(0);                            /*然后退出*/
	}
